        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Help-desk система в "ВМузее" для сотрудников и гостей музея "Эрмитаж"</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small>Войти как сотрудник</small>
              </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="#" class="text-light"><small>Войти как гость</small></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2018 <a href="https://www.ibisolutions.team" class="font-weight-bold ml-1" target="_blank">IBI Solutions</a>
          </div>
        </div>
      </div>
    </div>
