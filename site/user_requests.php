...
//$reqs = $request->read_free();

$reqs = $db->query("SELECT r.*, rc.name as rc_category, concat(u.name, ' ', u.lastname) as executer_name, 
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Мои заявки</h3>
            </div>
